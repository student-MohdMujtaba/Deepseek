    ...
    max-md:absolute max-md:h-screen ${expand ? "p-4 w-64" : "md:w-20 w-0 max-md:overflow-hidden"}`}>
            <div>
                <div className={`flex ${expand ? "flex-row gap-10" : "flex-col items-center gap-8"}`}>
                    <img className={expand ? "w-36" : "w-10"} 
                    ...
                    <div onClick={() => (expand ? setExpand(false) : setExpand(true))}
                        ...
                        <img src={expand ? assets.sidebar_close_icon : assets.sidebar_icon} alt=""
                            className="hidden  md:block w-7" />

                <div className={`absolute w-max ${expand ? "left-1/2 -trnaslate-x-1/2 top-12" : "-top-12 left-0"}
                ...
                <button
                    ...
                    ${expand
                            ...
                            : "group-relative h-9 w-9 max-auto rounded-lg"
                        }`}>

                    <img className={expand ? "w-6" : "w-7 ml-10"} src={expand ? assets.chat_icon : assets.chat_icon_dull}
                        alt=""/>
            ...
            <div>
                ...
                : "h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"}`}>
                    <img className={expand ? "w-5" : "w-6.5 mx-auto"}
                    ...
                    hidden group-hover:block transition`}>
                        <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
                            ...
                            <div className={`w-3 h-3 absolute bg-black rotate-45 ${expand ? "right-1/2" : "left-4"} -bottom-15`}></div>
                        </div>
                    </div>

                    {expand && 
                    <>
                        <span>Get App</span> <img src={assets.new_icon} alt="" />
                    </>
                    }
                </div>
